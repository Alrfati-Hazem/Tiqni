...
const faqs = [
  ...
  { q: "Do you work with existing teams or codebases?", a: "Absolutely. We can join an existing team, take over a legacy codebase, run an architecture review, or audit code — whatever your situation needs." },
  ...
  { q: "Do you build AI features?", a: "Practical AI capabilities — search, automation, assistants, and data insights — are a growing part of what we offer, added thoughtfully as your product matures." },
